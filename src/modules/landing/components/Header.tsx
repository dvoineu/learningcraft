...
import { locales, localeLabels, type Locale } from "@/shared/i18n/config";
...
export function Header({ locale, dictionary, authDictionary }: HeaderProps) {
        ...
        <nav className="hidden items-center gap-6 text-sm text-[var(--lc-muted)] md:flex">
          ...
          <div className="flex items-center gap-3 pl-4">
            <UserMenu 
              locale={locale} 
              dictionary={{
                profile: authDictionary.profile,
                myQuizzes: authDictionary.myQuizzes,
                settings: authDictionary.settings,
                signOut: authDictionary.signOut,
                signIn: dictionary.ctas.secondary.label
              }} 
            />
            <ThemeToggle />
          </div>
